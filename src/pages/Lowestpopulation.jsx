  ...
  useEffect(() => {
    const fetchLowestPopulation = async () => {
      try {
        ...
        // Reverse the data to start with the highest population among the lowest
    ...
    fetchLowestPopulation();
  }, []);

  return (
    <Container>
      <Title>Top 10 Countries With Lowest Population</Title>
...
export default Lowestpopulation;
